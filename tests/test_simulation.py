...
if __name__ == '__main__':
    ...
    dun_data, models = dn.read_file('simulation_test_files/M1.dun')
    model           = models['M1']
    ...
    #df.to_csv(f'simulation_test_files/M1_{x}.csv')
    ###
    ...
    #Test multiplicative simulation
    dun_data, models = dn.read_file('simulation_test_files/M2.dun')
    model            = models['M2']
    ...
    #Test non multiplicative simulation
    fig = plt.figure()
    gs  = fig.add_gridspec(2, 4) 
    AX  = [fig.add_subplot(gs[:,i]) for i in range(3)] + \
          [fig.add_subplot(gs[i,3]) for i in range(2)]
    ...
    #Part 3: Multi-Model
    ############################################################################### 
    dun_data, models = dn.read_file('simulation_test_files/M3.dun')
    ...
    #Part 4: .dun Files
    ############################################################################### 
    dun_data, models = dn.read_file('simulation_test_files/M4.dun')
