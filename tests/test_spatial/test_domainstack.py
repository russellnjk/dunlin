...
import addpath
import dunlin as dn
from dunlin.spatial.domainstack import DomainStack as Stack
...
domain_types = {'x': {'domains' : {'dmn0' : [0.5, 0.2]}
                      },
                'y': {'domains' : {'dmn1': [2.5, 2]}
                      },
                'z': {'domains' : {'dmn2': [0.5, 2.2],
                                   'dmn3': [2.5, 0.2]
                                   }
                      }
                }

surfaces = {'adj0': ['dmn0', 'dmn1'],
            'adj1': ['dmn0', 'dmn2'],
            'adj2': ['dmn0', 'dmn3'],
            'adj3': ['dmn1', 'dmn2'],
            'adj4': ['dmn1', 'dmn3']
