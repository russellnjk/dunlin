...
from dunlin.spatial.stack.eventstack import EventStack as Stack
...
###############################################################################
time       = 0
states     = stk.expand_init(np.arange(0, 4))
parameters = spatial_data.parameters.df.loc[0].values

trigger_func = stk._events[0].trigger_function
...
assign_func  = stk._events[0].assignment_function
