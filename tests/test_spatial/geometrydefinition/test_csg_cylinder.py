...
assert all(shape0.contains_points(points) == [True, False, True, False, False])
...
shape3 = csg.Cylinder()
shape4 = shape3('translate', 0.8, 0.8, 0)
...
print(shape3.contains_points(points))
assert all(shape3.contains_points(points) == [True,  True,  False,  False, False])
assert all(shape4.contains_points(points) == [False, True,  True,   True,  False])
assert all(shape5.contains_points(points) == [True,  True,  True,   True,  False])
assert all(shape6.contains_points(points) == [False, True,  False,  False, False])
assert all(shape7.contains_points(points) == [True,  False, False,  False, False])
